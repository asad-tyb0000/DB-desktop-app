...
namespace DesktopApp
{
    public partial class Viewclo : Form
    {
        ...
        private DataTable GetAllStudents()
        {
            ...
            string connectionString = "Data Source=DESKTOP-IC90SRH\\SQLEXPRESS01;Initial Catalog=desktopApp;Integrated Security=True;"; // Replace with your actual connection string
